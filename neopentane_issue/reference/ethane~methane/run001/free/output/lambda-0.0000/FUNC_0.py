...
stepframe = Parameter("step_frame",50,"""The number of frames to step to between two succcessive evaluations.""")
...
morphfile = Parameter("morphfile", "MORPH.pert",
                    """MORPH file.""")
lambda_val = Parameter("lambda_val",0.000,"""Value of lambda""")
